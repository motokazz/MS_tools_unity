...
/// Prefabを差し替えるウィンドウ
/// </summary>
public class ReplacingPrefabWindow_mod : EditorWindow
{
    ...
    //メニューからウィンドウを表示
    [MenuItem("Window/MS_Tools/ReplacingPrefabWindow_mod")]
    public static void Open()
    {
        ReplacingPrefabWindow_mod.GetWindow(typeof(ReplacingPrefabWindow_mod));
    }
