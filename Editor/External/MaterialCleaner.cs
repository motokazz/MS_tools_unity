	...
	public static void SetPropertyToMaterial(Material mat, MaterialProperty property)
	{
		switch (property.propertyType)
		{
			...
			case UnityEngine.Rendering.ShaderPropertyType.Texture:
				...
				Texture tex = null;
				if ((property.propertyFlags & UnityEngine.Rendering.ShaderPropertyFlags.PerRendererData) != UnityEngine.Rendering.ShaderPropertyFlags.PerRendererData)
				{
					tex = property.textureValue;
				}
				mat.SetTexture(property.name, tex);
				if ((property.propertyFlags & UnityEngine.Rendering.ShaderPropertyFlags.NoScaleOffset) != UnityEngine.Rendering.ShaderPropertyFlags.NoScaleOffset)
				{
