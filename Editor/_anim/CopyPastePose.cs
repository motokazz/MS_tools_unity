...
/// <summary>
/// ポーズコピーツール
/// 選択オブジェクトのトランスフォームの状態を一括して指定オブジェクトにコピーする
/// </summary>
...
public class CopyPastePose : MonoBehaviour
{
    ...
    [MenuItem("MS_Tools/Anim/CopyPastePose/Copy Pose")]
    ...
    [MenuItem("MS_Tools/Anim/CopyPastePose/Copy Pose", true)]
    static bool ValidateCopyPose()
    {
        return Selection.activeTransform != null;
    }

    [MenuItem("MS_Tools/Anim/CopyPastePose/Paste Pose")]
    ...
    [MenuItem("MS_Tools/Anim/CopyPastePose/Paste Pose", true)]
